...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { active_status: @suggestion.active_status, del_status: @suggestion.del_status, suggestion: @suggestion.suggestion, title: @suggestion.title } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { active_status: @suggestion.active_status, del_status: @suggestion.del_status, suggestion: @suggestion.suggestion, title: @suggestion.title } }
